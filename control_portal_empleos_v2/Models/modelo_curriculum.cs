...
{
    public abstract class modelo_curriculum
    {
        ...
        public List<documentos_curriculums> documentos_curriculums { get; set; }

 

    }

    public class super_modelo_curriculum : modelo_curriculum
    {
